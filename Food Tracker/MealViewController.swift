...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Set up views if eidting an existing Meal.
        if let meal = meal {
        ...
        // Enable the Sve button only if the text field has a valid Meal name.
    ...
    // This method lets you configure a view controller before it's presneted.
